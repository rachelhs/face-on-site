...
const SupportedBy = () => (
  <Section id="supportedBy">
    ...
    <ParagraphText>Visual Design for Face / On has been develop with <a href="https://copa-ipa.de/" target="_blank" rel="noopener noreferrer">Copa Ipa. </a>Metalwork by Tom Cherry. Produced with support from <a href="https://www.control-shift.network/index.html" target="_blank" rel="noopener noreferrer">Control Shift</a>. Thank you to Ruby Soho for lending your workshop and Professor Andrew Charlesworth for sharing your knowledge and ideas around facial recognition.</ParagraphText>
    </Container>
  </Section>
);
