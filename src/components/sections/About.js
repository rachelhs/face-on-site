...
import { Section, Title, TitleText, FirstContainer } from '@components/global';
...
const About = () => (
  <Section id="about">
    ...
    <Title><TitleText>ABOUT</TitleText></Title>
      ...
      Nam at velit a massa consectetur ultricies in at diam. Donec tristique elit felis, a rhoncus lorem tempor et. Donec a facilisis orci. Suspendisse efficitur leo massa, in tincidunt ligula commodo eget. Maecenas iaculis mollis ullamcorper. Mauris tristique felis.</h2>
    </FirstContainer>
  </Section>
);
